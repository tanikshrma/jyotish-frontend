...
export type StandardTrackingFieldKey = string;
export type RegisteredCustomFieldId = string;
export type TrackingCustomField = { value?: unknown; label: string };
export type TrackingFileField = { file?: File; label: string };
export type TrackingImageDataField = { dataUrl?: string; label: string };
