...
export const ASTRO_ENDPOINTS: Record<string, AstroEndpoint> = {
  ...
  "pdf-matching": { path: "pdf/matching-queue", tier: "paid", params: ["boy_dob", "boy_tob", "boy_tz", "boy_lat", "boy_lon", "boy_pob", "boy_name", "girl_dob", "girl_tob", "girl_tz", "girl_lat", "girl_lon", "girl_pob", "girl_name", "lang", "style", "color", "company_name", "address", "website", "email", "phone"], description: "Matchmaking PDF export" },
